...
/**
 *
 * @param {*} getValue A serializable value representing the file, most of the time its id
 * @param {*} FSCollection A Meteor file collection OR any class with and addFileFromReadable method (eg for Next Clouda)
 * @param {*} fieldValue
 */
